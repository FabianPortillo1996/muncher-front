...
const Product = ({name, price_sale, price_to_show, description, commerce,discount,photo}: ProductProps) => {
    ...
    return (
        <>
            ...
            <Body>
                <Images>
                    <div className="displayed">
                        ...
                        <div className="mobile-carousel">
                            ...
                            >
                                {photo.map((image : any, key : number) => (
                                    <img
                                        src={image.url}
                                        alt={image.url}
                                        key={key}
                ...
                <Details>
                    <Name>
                        <div className="brand">{commerce}</div>
                    ...
                    <ProductDetails>
                        ...
                        <Price>
                            ...
                            <div className="original-price">${price_sale}</div>
                        </Price>
                    </ProductDetails>
                    <Buttons>
                        ...
                        <div className="add-to-cart">
                            <button>
                                <img src={cart} alt={cart}/> Agregar al carrito
                            </button>
                        </div>
                    </Buttons>
                </Details>
